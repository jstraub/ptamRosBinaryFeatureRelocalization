...
// visodo-AM: changed in order to match new signature with imu data -- NOTE! GStreamer does
// not populate these variables, use ROS video source if you need imu data
