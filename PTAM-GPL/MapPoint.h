...
struct MapPoint
{
  ...
  // Info for BRIEF localization (not to be trashed by the MapMaker:)
  BriefData *pBData; // BRIEF data used for relocalization - always holds latest descriptor
  std::vector<BriefData*> bData; // holds pointers to all previous BRIEF descriptors of this MapPoint
